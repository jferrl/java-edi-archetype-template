...
public class AttrVec2fImplTests {
		...
		public void willBeCalledBeforeEachTestMethod() {
			...
			//
			vAt00 = new AttrVec2fImpl(0.0f, 0.0f);
			vAt11 = new AttrVec2fImpl(1.0f, 1.0f);
			vAt22 = new AttrVec2fImpl();
			vAt22 = new AttrVec2fImpl(vAt00);
		}
		...
		public void testHashCode() {
			...
			Vec2f vec = new AttrVec2fImpl(0.0f, 0.0f);
			Vec2f vec1 = new AttrVec2fImpl(0.0f, 0.0f);
		...
		public void testTranslate() {
			...
			Vec2f dx = new AttrVec2fImpl(2.0f, 2.0f);
		...
		public void testMagnitude() {
			...
			Vec2f vecMagnitude = new AttrVec2fImpl(3.0f, 4.0f);
		...
		Vec2f setVec = new AttrVec2fImpl(0.0f, 0.0f);
			
		setVec.setCx(1, 20.0f );
		setVec.setCx(2, 19.0f);
		
		Assert.assertEquals(20.0f,setVec.getCx(1), 0.00001);
		Assert.assertEquals(19.0f,setVec.getCx(2), 0.00001);
		...
		public void testEquals(){
			...
			Vec2f vec1 = new AttrVec2fImpl(1.0f, 0.0f);
			Vec2f vec2 = new AttrVec2fImpl(0.0f, 1.0f);
